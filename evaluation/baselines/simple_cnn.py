"""
SimpleCNN: Data-only baseline without physics loss.
"""
...
class SimpleCNN(nn.Module):
    """U-Net architecture without physics conditioning."""
    ...
    def forward(self, T, params):
        """
        Args:
            T: (batch, 1, H, W) current temperature
            params: (batch, 6) physics parameters
        Returns:
            (batch, 1, H, W) predicted next temperature
        """
